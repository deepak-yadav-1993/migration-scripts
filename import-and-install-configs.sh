...
echo "Enter the brew packages to install separated by space \nExample: git nvm helm\n"
read packages

brew install $packages

echo "Brewing basic graphic based applications\n visual-studio-code \n docker \n spotify \n graphql-ide \n iterm2 \n firefox \n google-chrome \n microsoft-teams\n"
brew cask install visual-studio-code docker spotify graphql-ide iterm2 firefox google-chrome
